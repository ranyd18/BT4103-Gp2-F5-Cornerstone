...
parser.add_argument('--dataset', type=str, default='f5', help='name of corpus')
parser.add_argument('--data_path', type=str, default='data/APM_VE1', help='directory containing data')
parser.add_argument('--emb_path', type=str, default='data/f5_embeddings.txt', help='directory containing word embeddings')
parser.add_argument('--save_path', type=str, default='./results/bigram', help='path to save results')
...
parser.add_argument('--t_hidden_size', type=int, default=100, help='dimension of hidden space of q(theta)')
parser.add_argument('--theta_act', type=str, default='relu', help='tanh, softplus, relu, rrelu, leakyrelu, elu, selu, glu)')
parser.add_argument('--train_embeddings', type=int, default=1, help='whether to fix rho or train it')
parser.add_argument('--product', type=str, default='AFM', help='product name')
...
if args.mode == 'eval':
    ...
    ckpt = os.path.join(args.save_path, 
        '{}_topic_{}'.format(
        args.product, args.num_topics))

## define model and optimizer
model = ETM(args.num_topics, vocab_size, args.t_hidden_size, args.rho_size, args.emb_size, 
                args.theta_act, embeddings, args.train_embeddings, args.enc_drop)
model.to(device)
